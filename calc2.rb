def outfit_input
    ...
    if equation>=365
        puts "You can make #{equation} outfits in one day, #{equation_week} outfit choices per day in one week, #{equation_month} outfit choices per day in one month, and #{equation_year} in one year (no repeat outfits!!) P.S: #{get_advice}"
    elsif equation>=30 
        puts "You can make #{equation} outfits in one day, #{equation_week} outfit choices per day in one week, and #{equation_month} outfit choices per day in one month! P.S: #{get_advice} "
    elsif equation>=7
        puts "You can make #{equation} outfits in one day and #{equation_week} outfit choices per day in one week! P.S: #{get_advice} "
    else 
